<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="History.aspx.vb" Inherits="ProjectJauharAkash._Default" %>
...
<section id="port" class="bg-danger">
  ...
  <!-- Title of the page -->
    ...
    <div id="grid" class="main">
      <div class="view-back"><a href="index.aspx"></a></div> </div>
